...
<form id="change_screen" name="change_screen" method="post" autocomplete="off">
    <div class="step3-body">
            ...
            <input id="title_template2"  placeholder="Escribe un título:" type="text" maxlength="50" style=" font-family: Georgia, 'Times New Roman', serif;" name="title">  
            ...
            <textarea id="text_template2" placeholder="Escribe un texto:" maxlength="1000" wrap="hard" name="text" ></textarea>
