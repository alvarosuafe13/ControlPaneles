...
<form id="change_screen" name="change_screen" enctype="multipart/form-data" method="post" autocomplete="off">
    <div class="step3-body">

         <input id="title_template3" maxlength="80" placeholder="Escribe un título:" type="text"  style=" font-family: Georgia, 'Times New Roman', serif;" name="title">  
            ...
            <input class="input-file" name="image" id="my-file" type="file" accept="image/*">
            <label tabindex="0" for="my-file" class="input-file-trigger">Seleciona una imagen</label>
